...
const steps: {
  ...
  },
  {
    ...
    contents: [
      { name: "Iniciante", emoji: <Emoji accessibilityLabel={"Iniciante"} size={30}>🐣</Emoji> },
      { name: "Médio", emoji: <Emoji accessibilityLabel={"Médio"} size={30}>🦸</Emoji> },
      { name: "Avançado", emoji: <Emoji accessibilityLabel={"Avançado"} size={30}>🧙</Emoji> },
    ],
  ...
  },
  {
    ...
    contents: [
      { name: "Ação", emoji: <Emoji accessibilityLabel={"Acção"} size={30}>⚔️</Emoji> },
      { name: "Clássico", emoji: <Emoji accessibilityLabel={"Clássico"} size={30}>️</Emoji> },
      { name: "Fantasia", emoji: <Emoji accessibilityLabel={"Fantasia"} size={30}>🦄</Emoji> },
      { name: "Magia", emoji: <Emoji accessibilityLabel={"Magia"} size={30}>🔮</Emoji> },
      { name: "Medieval", emoji: <Emoji accessibilityLabel={"Medieval"} size={30}>👑</Emoji> },
      { name: "Mistério", emoji: <Emoji accessibilityLabel={"Mistério"} size={30}>🔍</Emoji> },
      { name: "Cooperativo", emoji: <Emoji accessibilityLabel={"Cooperativo"} size={30}>🤝</Emoji> },
      { name: "Ficção", emoji: <Emoji accessibilityLabel={"Ficção"} size={30}>🧬</Emoji> },
      { name: "Horror", emoji: <Emoji accessibilityLabel={"Horror"} size={30}>👻</Emoji> },
    ],
  },
  {
    label: "disponibility",
