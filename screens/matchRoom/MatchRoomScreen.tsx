  ...
  return (
    <Container>
      <ScrollView marginTop={"-20"}>
        ...
        <View>
          <Heading marginLeft={15} mb={2} color={"brand.600"} fontSize={"sm"}>Sobre o jogo</Heading>
          <Text marginLeft={15} marginRight={15} fontSize={11} justifyContent={"center"}>
            Gloomhaven is a game of Euro-inspired tactical combat in a persistent world of shifting motives. Players will take on the role of a wandering adventurer with their own special set of skills and their own reasons for traveling to this dark corner of the...
          </Text>
        </View>
      ...
      <View>
        <Heading marginTop={10} paddingLeft={15} marginBottom={5}>Jogadores</Heading>
        <HStack marginLeft={5} space={4}>
        <Avatar onTouchEnd={() => navigation.navigate("Profile") } borderWidth={2} borderColor={"yellow.300"} size="lg" source={
          require("../../assets/images/personas/persona4.png")
        }>
        </Avatar>
          <Avatar borderWidth={2} borderColor={"brand.300"} size="lg" source={
